...
def main():
    ...
    with torch.no_grad():
        ...
        plot_feature_maps(s1, "Stage 1 (Early Conv)")
        plot_feature_maps(s2, "Stage 2")
        plot_feature_maps(s3, "Stage 3 (Mid Features)")
        plot_feature_maps(s4, "Stage 4")
        plot_feature_maps(s5, "Stage 5 (Deep Features)")
