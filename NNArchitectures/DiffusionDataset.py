...
# A Class used to store directory references to images, when an image is called, the transform
# specified in the constructor is applied, the only transform used in this project is mapping
# greyscale values from [0-255] to [0-1]
